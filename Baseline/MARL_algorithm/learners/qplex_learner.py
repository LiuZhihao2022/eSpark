...
class QLearner:
    ...
    def train(self, batch: EpisodeBatch, t_env: int, episode_num: int):
        ...
        if self.args.use_double_q:
            ...
            gpu_id = 0 if not hasattr(self.args, "gpu_id") else self.args.gpu_id
            cur_max_actions_onehot = th.zeros(cur_max_actions.squeeze(3).shape + (self.n_actions,)).cuda(gpu_id)
