...
def run_sequential(args, logger):
    ...
    # if checkpoint_path is not none, load model parameter and continue to train
    ...
    if args.visualize:
        # Choose only top layer is trained or two layers are trained together
        # visual_runner = r_REGISTRY["episode_for_different_order_cost"](args=test_args, logger=logger)
    ...
    #     # TODO: just for test
    #     # visual_runner.run(test_mode = True)
