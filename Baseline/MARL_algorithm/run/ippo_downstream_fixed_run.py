...
def run_sequential(args, logger):
    ...
    # Set the fixed number of replenishment here. The top layer is not influenced by this.
    runner.set_stock_levels[1][0] = 50
    ...
    if args.checkpoint_path:
        visual_runner.mac.load_models(args.checkpoint_path, postfix = '_4380800')
